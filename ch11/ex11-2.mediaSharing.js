// 리스트 11.2  mediaSharing.js(브라우저의 자바스크립트)
  ...
  if (identityId == null) {
    ...
    actions.innerHTML =
      '<form class="form-inline" role="form" id="login-form">' +
        ...
        '<div class="form-group">' +
          ...
          '<iput type="password"> class="form-control" id="password">' +
         '</div>' +
    ...
    actions.innerHTML =
      '<form class="form-horizontal" role="form" id="add-picture-form">' +
        '<div class="form-group">' +
          '<label class="control-label col-sm-2" for="mediaFile">' +
            'Photo to Upload</label>' +
          '<div class="col-sm-10">' +
        ...
        '<div class="form-group">' +
          ...
          '<div class="col-sm-10">' +
            '<input type="checkbox" value="" name="is-public" is="is-public" placeholder="is-public">' +
          '</div>' +
        '</div>' +
        '<div class="form-group">' +
        ...
        '<div class="form-group">' +
          ...
          '<div class="col-sm-10">' +
            '<input type="text" class="form-control" name="descrition" id="description" placeholder="description">' +
          '</div>' +
        '</div>' +
        '<div class="form-group">' +
...
function getSignedUrlFromKey(key) {
  ...
  console.log('The URL is', url); // 60초 후에 만료된다.
...
function renderContents() {
  index = {};
  console.log(publicContext.index);
  ...
  for(var objectKey in index) {
    ...
    html += '<div class="col-sm-3 thumbnail alert ' +
      ...
      '<a data-toggle="modal" data-target="#myModalDetial" ' +
